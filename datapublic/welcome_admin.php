...
<body>
    ...
    <p>
        <a href="./controlpanel/activities_create.php" class="btn btn-warning">Create Activity</a>
        <a href="./controlpanel/activities_manage.php" class="btn btn-danger">Manage Activities</a>
    </p>
    <p>
    	<a href="../covid19/toolkits/" class="btn btn-warning">COVIZ toolkits</a>
